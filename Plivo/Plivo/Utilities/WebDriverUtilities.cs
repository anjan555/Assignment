...
namespace Plivo.SeleniumCore.Utilities
{
    public static class WebDriverUtilities
    {
        ...
        public static void CaptureScreenShot(string _scenarioTitle)
        {  
            var screenshot = ((ITakesScreenshot)Driver.driver).GetScreenshot();
            screenshot.SaveAsFile(Helpers.Helper.CreateFolder("PlivoTestResult") + "/" + _scenarioTitle + ".Png", ScreenshotImageFormat.Png);
